...
tend =   0.85
tclose = 0.8
fname = os.path.join('topo','flumedoorsTXYZ.txt')
...
gate_angle_oft = interpolate.interp1d(tgate,thetaav,kind=2,bounds_error=False,fill_value = 90.0)

pplt.plot(tgate,thetaav,'r.',T,gate_angle_oft(T),'b')
pplt.show()
#pdb.set_trace()

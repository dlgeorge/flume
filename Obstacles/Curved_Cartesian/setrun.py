...
#------------------------------
    ...
    clawdata.inratx = [5,5,4,4]
    clawdata.inraty = [5,5,4,4]
    clawdata.inratt = [5,5,4,4]
...
def setgeo(rundata):
    ...
    topofile5=os.path.join(topopath,'CurvedWall.tt2')
    ...
    geodata.topofiles.append([2, 2, 2, 0.0, 5.0, topofile4])
    geodata.topofiles.append([2, 2, 4, 0.0, 1.e10, topofile5])
    ...
    geodata.qinitfiles.append([2,6,2,2,'topo/FlumeQinit.tt2'])
    ...
    #geodata.auxinitfiles.append([2,4,1,2,'aux/FlumePhi.tt2'])
    geodata.auxinitfiles.append([2,5,1,2,'aux/FlumeTheta.tt2'])
